...
function addItem(textItem) {
  // Функцию переписываю для сокращения кода с 25 строк до 7 по принципу клонирования блока-образца (здесь пока закомментировано). Прототип на 25 строк тоже рабочий
