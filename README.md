...
12.	Счетчик выбранных деталей с изменяемым окончанием слова;
13.	Всплывающее окно с предложением записаться на осмотр при нахождении пользователя внутри блока с калькулятором в течение заданного времени (в примере - 10 сек). При покидании блока до истечения времени появления всплывающего окна таймер отменяется, и всплывающее окно не отображается.

<b>Признаю, что в HTML документе многовато SVG-кода, работаю над его сокращением. Можно подставить свой SVG-код, расставив классы и ID на соответствующие path'ы</b>
