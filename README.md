...
https://autoservise36.ru/autokraftwerk.html#calculator (по ссылке - без всплывающего окна, функция с всплывающим окном была добавлена позже размещения демо-версии на хостинге)
